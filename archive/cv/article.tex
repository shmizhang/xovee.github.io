...
\begin{enumerate}[resume]
    ...
    \item Fan Zhou, \textbf{Xovee Xu}*, Goce Trajcevski, Kunpeng Zhang. 2021. A survey of information cascade analysis: Models, predictions, and recent advances. \textit{ACM Computing Surveys}, vol. 54, no. 2, article 27, 36 pages, Mar 2021. 
\end{enumerate}

\cvsubsection{Refereed Conference Articles}

\begin{enumerate}[resume]
    \item Ting Zhong, Haoyang Yu, Rongfan Li, \textbf{Xovee Xu}*, Xucheng Luo, and Fan Zhou. 2022. Probabilistic fine-grained urban flow inference with normalizing flows. IEEE International Conference on Acoustics, Speech, and Signal Processing (ICASSP), Singapore \& Online, May 23-27, 2022, pp. 3663-3667.
