...
\cvsubsection{On-going Articles}

\begin{enumerate}[resume]
    \item Liu Yu, Xovee Xu, Ting Zhong, Goce Trajcevski, and Fan Zhou. 2021. Linking Transformer to Hawkes process for information cascade prediction. Under review [Abstract], 2021
    \item Guanyu Wang, Xovee Xu, Ting Zhong, and Fan Zhou. 2021. Conditional collaborative filtering process for top-k recommender system. Under review [Abstract], 2021
    \item Haoyang Yu, Xovee Xu, Ting Zhong, and Fan Zhou. 2021. Fine-grained urban flow inference via normalizing flows. Under review [Abstract], 2021
